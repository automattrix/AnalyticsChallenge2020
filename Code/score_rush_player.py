...
def main():
    ...
    for player in unique_players:
        ...
        unique_positions = df_player['TechniqueNameLR'].unique()
        ...
        for position in unique_positions:
            ...
            pdiaa_dict[f"{player}_{position}"] = [pdiaa_avg, pdiaa_sum, pdiaa_count]
    ...
    pdiaa_df.to_csv('./data/04_graph_inputs/pdira_player.csv', index=False)
    print(pdiaa_df)
